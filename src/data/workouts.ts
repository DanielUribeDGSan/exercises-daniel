...
export const exercises: readonly Exercise[] = [
  ...
  },
  {
    ...
    instructions: [
      ...
      'Baja el pecho con control y empuja el suelo sin abrir demasiado los codos.',
    ],
  },
  {
    id: 'hammer-curl',
    ...
    instructions: [
      ...
      'Sube con control y baja lentamente hasta extender los brazos.',
    ],
  },
  {
    id: 'glute-bridge',
    name: 'bodyweight glute bridge',
    shortName: 'Puente de glúteo',
    equipment: 'Peso corporal',
    target: 'Glúteo y femoral',
    sets: 4,
    reps: '12–15',
    seconds: 40,
    ...
    instructions: [
      ...
      'Haz una pausa arriba y desciende lentamente sin perder el control.',
    ],
  },
  {
    id: 'barbell-curl',
    name: 'barbell biceps curl',
    shortName: 'Curl de bíceps con barra',
    equipment: 'Barra',
    target: 'Bíceps',
    sets: 4,
    reps: '8–12',
    ...
    instructions: [
      ...
      'Mantén los codos junto al torso y el abdomen firme.',
      'Sube sin impulsarte con la espalda y baja la barra de forma controlada.',
    ],
  },
] as const;
...
export const workouts: readonly Workout[] = [
  {
    ...
    calories: 310,
    intensity: 'Intenso',
    exerciseIds: ['0289', 'push-up', '0405', '2188', '0857', '0872'],
  },
  {
    id: 'martes',
    day: 'Martes',
    ...
    calories: 330,
    intensity: 'Intenso',
    exerciseIds: ['0293', '0294', 'hammer-curl', '3123', '0689', '0630'],
  },
  {
    id: 'miercoles',
    day: 'Miércoles',
    ...
    exerciseIds: ['0003', '0276', '3544', '0687', '0620', '0997'],
  },
  {
    id: 'jueves',
    day: 'Jueves',
    ...
    calories: 370,
    intensity: 'Intenso',
    exerciseIds: ['1760', '1459', '0336', '3007', 'glute-bridge', '0630'],
  },
  {
    id: 'viernes',
    day: 'Viernes',
    title: 'Tren superior & abdomen',
    focus: 'Pecho, bíceps y core',
    duration: 45,
    calories: 345,
    intensity: 'Moderado',
