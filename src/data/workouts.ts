...
export const exercises: readonly Exercise[] = [
  ...
  },
  {
    id: '2612',
    name: 'jump rope',
    shortName: 'Salto de cuerda',
    equipment: 'Cuerda',
    target: 'Cardio',
    sets: 5,
    reps: '60 s',
    seconds: 60,
    image: '/media/2612-e1e76I2.jpg',
    gif: '/media/2612-e1e76I2.gif',
    instructions: [
      'Salta bajo y aterriza sobre el antepié.',
...
export const workouts: readonly Workout[] = [
  ...
  },
  {
    ...
    exerciseIds: ['2612', '0276', '3544', '0997'],
  },
  {
    id: 'jueves',
    day: 'Jueves',
    ...
    calories: 370,
    intensity: 'Intenso',
    exerciseIds: ['1760', '1459', '0336', '2612'],
  },
  {
    id: 'viernes',
    day: 'Viernes',
    ...
    calories: 345,
    intensity: 'Moderado',
    exerciseIds: ['1760', '0289', '0293', '0405', '0857', '0620', '2612'],
  },
] as const;
